...
function momentumScroll(dataObj) {
    ...
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_0__.isCompatible)()) {
        ...
        rootElem.addEventListener("scroll", (event) => {
            ...
            if (activeOffsets) {
                activeOffsets.forEach((e) => {
                    ...
                    let nodes = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.selectNode)(e.element, true);
        ...
        if (activeFixedOffsets) {
            activeFixedOffsets.forEach((element) => {
                let nodes = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.selectNode)(element, true);
                if (Symbol.iterator in Object(nodes)) {
                    // If multiple nodes are selected
                    for (let e of nodes) {
